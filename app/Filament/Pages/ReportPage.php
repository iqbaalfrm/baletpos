...
class ReportPage extends Page implements HasForms
{
    ...
    public $omset = 0;
    public $modal_terjual = 0; // HPP (Cost of Goods Sold)
    public $biaya_operasional = 0;
    public $laba_kotor = 0;
    public $laba_bersih = 0;
    ...
    public function updateReport()
    {
        ...
        // Hitung Modal Barang yang Laku (HPP)
        $this->modal_terjual = TransactionDetail::whereHas('transaction', function ($q) use ($start, $end) {
        ...
        $this->laba_kotor = $this->omset - $this->modal_terjual;
